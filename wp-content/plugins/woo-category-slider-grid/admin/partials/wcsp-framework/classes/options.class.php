...
if ( ! class_exists( 'SP_WCS_Options' ) ) {
	class SP_WCS_Options extends SP_WCS_Abstract {
		...
		public function set_options() {
			...
			if ( wp_verify_nonce( spf_get_var( 'spf_options_nonce' ), 'spf_options_nonce' ) ) {
				...
				if ( ! empty( $transient['spf_import_data'] ) ) {
					...
					$this->notice = esc_html__( 'Success. Imported backup options.', 'woo-category-slider' );
					...
					$this->notice = esc_html__( 'Default options restored.', 'woo-category-slider' );
					...
					$this->notice = esc_html__( 'Default options restored for only this section.', 'woo-category-slider' );
				...
				if ( empty( $this->notice ) ) {
					$this->notice = esc_html__( 'Settings saved.', 'woo-category-slider' );
				}
			}
		...
		public function add_options_html() {
			...
			echo '<input type="submit" name="' . $this->unique . '[_nonce][save]" class="button button-primary spf-save' . $ajax_class . '" value="' . esc_html__( 'Save', 'woo-category-slider' ) . '" data-save="' . esc_html__( 'Saving...', 'woo-category-slider' ) . '">';
			echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="spf_transient[reset_section]" class="button button-secondary spf-reset-section spf-confirm" value="' . esc_html__( 'Reset Section', 'woo-category-slider' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset this section options?', 'woo-category-slider' ) . '">' : '';
			echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="spf_transient[reset]" class="button button-secondary spf-warning-primary spf-reset-all spf-confirm" value="' . esc_html__( 'Reset All', 'woo-category-slider' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset all options?', 'woo-category-slider' ) . '">' : '';
			echo '</div>';
				...
				if ( ! empty( $section['fields'] ) ) {
					...
					foreach ( $section['fields'] as $field ) {
						...
						SP_WCS::field( $field, $value, $this->unique, 'options' );
								  ...
								  echo '<div class="spf-no-option spf-text-muted">' . esc_html__( 'No option provided by developer.', 'woo-category-slider' ) . '</div>';
			...
			// 	echo '<div class="spf-buttons">';
			// 	echo '<input type="submit" name="spf_transient[save]" class="button button-primary spf-save' . $ajax_class . '" value="' . esc_html__( 'Save', 'woo-category-slider' ) . '" data-save="' . esc_html__( 'Saving...', 'woo-category-slider' ) . '">';
			// 	echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="spf_transient[reset_section]" class="button button-secondary spf-reset-section spf-confirm" value="' . esc_html__( 'Reset Section', 'woo-category-slider' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset this section options?', 'woo-category-slider' ) . '">' : '';
			// 	echo ( $this->args['show_reset_all'] ) ? '<input type="submit" name="spf_transient[reset]" class="button button-secondary spf-warning-primary spf-reset-all spf-confirm" value="' . esc_html__( 'Reset All', 'woo-category-slider' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset all options?', 'woo-category-slider' ) . '">' : '';
			// 	echo '</div>';
