			...
			array(
				...
				'fields' => array(
					array(
						...
						'type'     => 'checkbox',
						'title'    => __( 'Remove Data when Delete', 'woo-category-slider' ),
						'subtitle' => __( 'Check this box if you would like Category Slider for WooCommerce to completely remove all of its data when the plugin is deleted.', 'woo-category-slider' ),
						'default'  => false,
					),
					array(
						'type'    => 'subheading',
