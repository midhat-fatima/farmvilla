	...
	<form id="eg-form-create-settings">
			...
			<div>
				<div>
					...
					<div class="eg-cs-tbc">						
						...
						--><input name="main-background-color" type="text" id="main-background-color" value="<?php echo $base->getVar($grid, array('params', 'main-background-color'), 'transparent'); ?>">						
					</div>
				</div>
		...
		<div id="esg-settings-lightbox-settings" class="esg-settings-container">							
			...
			<div>				
				...
				<div>
					<div class="eg-cs-tbc-left"><esg-llabel class="box-closed"><span><?php _e('AutoPlay', EG_TEXTDOMAIN); ?></span></esg-llabel></div>
					<div class="eg-cs-tbc">					
						...
						<div class="div13"></div>
						<label><?php _e('AutoPlay Speed:', EG_TEXTDOMAIN); ?></label><!--
