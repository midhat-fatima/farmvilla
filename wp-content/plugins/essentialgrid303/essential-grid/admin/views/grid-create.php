					...
					<div id="post-pages-wrap">
						<div class="">
							...
							<div class="eg-cs-tbc">
								...
								--><select name="post_types" size="5" multiple>
									<?php
...
<script type="text/javascript">
	...
	if (document.readyState === "loading") window.addEventListener('DOMContentLoaded',function() { esg_grid_create_ready_function();}); else esg_grid_create_ready_function();
</script>
