									...
									<div id="postbox-container-2" class="postbox-container">
										<div id="advanced" class="meta-box-sortables">
											<div id="gallery_bank_get_started" class="postbox" >
												...
												<h2 class="hndle"><span><?php esc_html_e('Get More Free Wordpress Plguins From Weblizar', WEBLIZAR_PINIT_TD); ?></span></h2>
												<div class="inside">
																			...
																			<div class="plugin-div plugin-div-settings">
																				...
																				<div class="plugin-card-bottom plugin-card-bottom_settings">
																					...
																					<div class="column-updated">
																						<strong><?php esc_html_e("Last Updated:"); ?></strong> <span title="<?php echo esc_attr($plugin["last_updated"]); ?>">
