					...
					<esg-row>
						...
						<esg-cell class="cell_4">
							<div class="btn-wrap-overview-<?php echo $grid->id; ?>" style="margin-bottom:-5px">
								...
								--><a class="esg-btn esg-green" href="<?php echo Essential_Grid_Base::getViewUrl(Essential_Grid_Admin::VIEW_ITEM_SKIN_EDITOR, 'create='.$skin_id); ?>" target="_blank"><i class="eg-icon-palette"></i><esg-btntxt><?php _e("Edit Skin", EG_TEXTDOMAIN); ?></esg-btntxt></a><!--
